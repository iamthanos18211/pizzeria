...
{ var display_student_array = [];
     ...
     - "+ name_of_the_student_array[k] + "</h4>"); console.log(display_student_array); } console.log(display_student_array);
...
document.getElementById("sort_button").style.display = "inline_black";
}
function sorting ()
{
    ...
    var remove_commas = display_student_array.joint ("");
    console.log (remove_commas);
